...
class PanPhlAnParser(ArgumentParser):
    ...
    def __init__(self):
        ...
        self.add_argument('-m', '--mGB',            metavar='MEMORY_GIGABTES_FOR_SAMTOOLS', type=float, default=4.0,                                                help='Maximum amount of memory we get available for Samtools.')
        self.add_argument('--readLength',           metavar='READS_LENGTH',                 type=int,   default=DEFAULT_READ_LENGTH,                    help='Minimum read length, default: 70')
        self.add_argument('--tmp',                  metavar='TEMP_FOLDER',                  type=str,   default='TMP_panphlan_map',                     help='Alternative folder for temporary files.')
...
def check_args():
    ...
    print('[I] Output file name: ' + args_set['output'])
